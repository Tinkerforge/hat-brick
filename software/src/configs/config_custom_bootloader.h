...
#define BOOTLOADER_CUSTOM_PIN1         P2_10 // RPi enable
#define BOOTLOADER_CUSTOM_PIN2         P2_11 // Bricklet enable
#define BOOTLOADER_CUSTOM_PIN3         P1_6  // Boost enable

#define BOOTLOADER_CUSTOM_PIN1_OUTPUT_LEVEL XMC_GPIO_OUTPUT_LEVEL_HIGH
#define BOOTLOADER_CUSTOM_PIN2_OUTPUT_LEVEL XMC_GPIO_OUTPUT_LEVEL_HIGH
#define BOOTLOADER_CUSTOM_PIN3_OUTPUT_LEVEL XMC_GPIO_OUTPUT_LEVEL_HIGH
